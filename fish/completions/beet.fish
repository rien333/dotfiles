...
set CMDS completion config edit fetchart fields fish ? help imp im import info lastgenre ls list mod modify mv move play rm remove scrub stats upd up update version write zero
